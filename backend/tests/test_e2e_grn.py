...
def test_e2e_grn_complex_flow():
    ...
    ack_data = {"lines": {spo_item_id: {"quantity_confirmed": 100, "unit_price": 50.0}}}
    r = client.post(
    ...
    r_item1 = client.post(
        f"/api/v1/grns/{grn1_id}/items", json=item_data, headers=headers
    )
    ...
    r_disp1 = client.post(
        f"/api/v1/grns/{grn1_id}/items/{grn1_item_id}/disposition",
        json=disp1,
        headers=headers,
    )
    ...
    r_item2 = client.post(
        f"/api/v1/grns/{grn2_id}/items", json=item_data, headers=headers
    )
    ...
    r_disp2 = client.post(
        f"/api/v1/grns/{grn2_id}/items/{grn2_item_id}/disposition",
        json=disp2,
        headers=headers,
    )
