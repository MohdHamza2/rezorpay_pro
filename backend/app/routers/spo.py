...
async def create_spo(
    ...
    return await SPOService.create_draft(session, workspace_id, spo_in, current_user.id)
...
async def submit_spo(
    ...
    return await SPOService.submit_for_approval(session, spo_id, current_user.id)
...
async def approve_spo(
    ...
    return await SPOService.approve(session, spo_id, current_user.id)
...
async def send_spo(
    ...
    return await SPOService.send(session, spo_id, current_user.id)
...
async def acknowledge_spo(
    ...
    return await SPOService.acknowledge(session, spo_id, ack_req, current_user.id)
...
async def cancel_spo(
    ...
    return await SPOService.cancel(session, spo_id, reason, current_user.id)
