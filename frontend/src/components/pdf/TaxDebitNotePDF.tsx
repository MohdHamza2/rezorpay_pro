...
import type { TaxDebitNote, TaxDebitNoteItem } from '../../api/debitNotes';
...
function discountLabel(item: TaxDebitNoteItem): string {
...
function SellerBlock({ cn, workspace }: { cn: TaxDebitNote; workspace?: Workspace }) {
...
function BuyerBlock({ cn, client }: { cn: TaxDebitNote; client?: Client }) {
  ...
  return (
    <View style={styles.clientSection}>
      <PdfStackedLabel en={PDF_LABELS.debitTo.en} ar={PDF_LABELS.debitTo.ar} boldEn />
...
function LineRow({ item }: { item: TaxDebitNoteItem }) {
  return (
  ...
  return (
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <PdfDualTitle en={PDF_TITLES.taxDebitNote.en} ar={PDF_TITLES.taxDebitNote.ar} />
        ...
        <View style={styles.summary}>
          ...
          <View style={styles.summaryTotal}>
            <PdfStackedLabel en={PDF_LABELS.debitTotalAed.en} ar={PDF_LABELS.debitTotalAed.ar} boldEn />
...
export async function downloadTaxDebitNotePdf(args: {
  cn: TaxDebitNote;
  client?: Client;
  workspace?: Workspace;
  invoice?: Invoice;
